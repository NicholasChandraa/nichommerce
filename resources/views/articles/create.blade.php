...
<body class="bg-gray-100">
    ...
    <div class="flex items-center justify-center min-h-screen p-5">
        <div class="bg-white shadow-md rounded-lg p-5 w-full max-w-3xl">
            <h1 class="text-3xl font-bold mb-6 text-center">Buat Artikel</h1>
            <form id="create-article-form" method="POST" action="{{ route('articlePages.store') }}"
    ...
    <div id="confirmationModal" class="modal flex">
        <div class="modal-content">
            ...
            <p>Apakah kamu yakin ingin membuat artikel?</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Close modal ketika user klik diluar dari area modal
